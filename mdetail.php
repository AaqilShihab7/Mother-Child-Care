...
<html>
<head>
  <title>Add Mother's details</title>
  <link rel="stylesheet" type="text/css" href="style1.css">
</head>
<body>
  <div class="header">
  	<h2>Add Mother's Deails</h2>
  </div>
	
  <form method="post" action="pro4.php">
    ...
    <div class="input-group">
      ...
      <input type="text" name="pregnancyno" placeholder="incliding this" value="">
    </div>
    <div class="input-group">
    ...
    <div class="input-group">
      <label>Last Child Age</label>
      <input type="text" name="lastchildage" value="">
    </div>
    <div class="input-group">
    ...
    <div class="input-group">
      <label>Date of First Clinic</label>
      <input type="date" name="firstclinic" value="">
    </div>
    <div class="input-group">
      <label>Date of End Clinic</label>
      <input type="date" name="endclinic" value="">
    </div>
    <div class="input-group">
